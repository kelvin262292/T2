...
- Name: Homepage Tests >> should display product categories
- Location: C:\Users\AB\Documents\New folder\client\tests\homepage.spec.ts:17:3
...
Locator: locator('[data-testid="category"], .category, .product-category').first()
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for locator('[data-testid="category"], .category, .product-category').first()

    at C:\Users\AB\Documents\New folder\client\tests\homepage.spec.ts:25:38
```
