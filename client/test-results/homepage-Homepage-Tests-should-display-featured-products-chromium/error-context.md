...
- Name: Homepage Tests >> should display featured products
- Location: C:\Users\AB\Documents\New folder\client\tests\homepage.spec.ts:28:3
...
Call log:
  ...
  - waiting for locator('[data-testid="product"], .product, .product-card').first()
    ...
    at C:\Users\AB\Documents\New folder\client\tests\homepage.spec.ts:36:36
```
